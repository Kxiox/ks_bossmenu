            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="salaryModalLabel">
                        <i class="bi bi-cash"></i> {{ $t('salaries.change_salary') }}
                    </h1>
                ...
                <div class="modal-body">
                    <div class="input-group">
                        ...
                        <input id="newSalary" type="number" class="form-control" :placeholder="$t('salaries.placeholder')" aria-label="Salary" min="0">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-second" data-bs-dismiss="modal">{{ $t('buttons.cancel') }}</button>
                    <button type="button" class="btn btn-main" data-bs-dismiss="modal" @click="changeSalary()">{{ $t('buttons.change') }}</button>
                </div>
            </div>
        </div>
    </div>
